...
def extract_invoice_details(text):
    ...
    # Extract shipping and billing details with more flexible patterns
    ...
    # extraction for balance / payment details
...
json_data = convert_with_pdfplumber(pdf_path)


with open("invoice_pdfplumber.json", "w") as f:
